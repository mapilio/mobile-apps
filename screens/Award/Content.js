      ...
      <Fragment>
        ...
        <View style={{ paddingHorizontal: RFValue(16) }}>
          ...
          <TouchableOpacity
            onPress={() => {
              ...
              navigation.navigate(Routes.stackNavigator, {
                ...
                params: {
                  screen: Routes.webview,
                  params: { url: 'https://mapilio.com/rules-of-contest-webview' },
                },
              });
            }}>
          ...
          <View style={styles.finalContent}>
            <Text style={styles.finalContent.title}>{t('final_content.title')}</Text>
            <Text style={styles.finalContent.description}>{t('final_content.description')}</Text>
          </View>
        </View>

        <View style={styles.bottomContent}>
          <AwardCompanies width={width} height={width * 0.75} />
