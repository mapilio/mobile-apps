...
const awards = [
  {medal: require('../../assets/images/goldMedal.png'), title: 'mi_pro_2_scooter'},
  {medal: require('../../assets/images/silverMedal.png'), title: 'gopro_9'},
  {medal: require('../../assets/images/bronzeMedal.png'), title: 'beats_3_headphones'}
]

const Award = ({setOnScroll}) => {
    ...
    >
      ...
      <Fragment>
        <Text style={styles.summary}>
          <Trans t={t} components={[<Text style={styles.fs30}/>]} i18nKey={'summary'}/>
        </Text>

        <Button title={t('start_capture_now')} containerStyle={styles.button} onPress={pressHandler}/>

        <Text style={styles.slogan}>
          <Trans t={t} components={{bold: <CustomTextBold/>}} i18nKey={'slogan'}/>
        </Text>
        ...
        <View style={{paddingHorizontal: RFValue(16)}}>
          ...
          <Text style={styles.description}>
            <Trans t={t} i18nKey={'description'} components={{date: <Text style={styles.date}/>}}/>
          </Text>
        ...
        <View style={styles.bottomContent}>
          ...
          <LinearGradient
            colors={['#FFFFFF00', '#FFFFFF24', '#FFFFFF42', '#FFFFFF91', '#FFFFFFC7', '#FFFFFFE7', '#FFFFFFEF', '#FFFFFFF7']}
