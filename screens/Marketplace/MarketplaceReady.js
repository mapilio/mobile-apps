...
const MarketplaceReady = ({ navigation, route }) => {
  ...
  const goToMarketPlace = () => (
    <CustomTextBold style={marketplaceReceivedStyles.link} onPress={() => navigation.navigate(Routes.marketplace)}/>
  )
  ...
  return (
    <View style={marketplaceReceivedStyles.container}>
      ...
      >
        <CustomText style={marketplaceReceivedStyles.startCapture}>
          {t("start_capture")}
        </CustomText>
      </TouchableOpacity>
      <CustomTextBold style={marketplaceReceivedStyles.or}>
        {t("or")}
      </CustomTextBold>
