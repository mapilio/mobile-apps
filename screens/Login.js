    ...
    return (
        <View style={[globalStyles.container, loginStyles.container]}>
            ...
            <Formik initialValues={{
                email: '',
                password: '',
            }} validateOnBlur={false} validateOnChange={false} validationSchema={loginValidationSchema}
                ...
                {({handleChange, handleBlur, handleSubmit, values, errors, isValid}) => (
                    <>
                        ...
                        <CustomText style={loginStyles.smallText}>Don't have an account yet?
                        ...
                        <Pressable onPress={() => navigation.navigate(Routes.map)}>
                            <CustomText style={{
                                ...
                                textAlign: "center"
                            }}>Continue without a member</CustomText>
                        </Pressable>
                    </>
                )}
            </Formik>
