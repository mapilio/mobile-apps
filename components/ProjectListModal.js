...
const ProjectListModal = ({ modalVisible, setModalVisible }) => {
  ...
  useEffect(() => {
    api
      .get('/api/function/projects/job/getMyJobs')
      .then((res) => {
        setLoading(false);
        setProjects(res.data);
      })
      .catch(() => {
        toast.show(`There was a problem fetching your jobs. Please try again.`, {
          type: 'warning',
        });
      });
  }, []);
      ...
      <Modal
        ...
        <View style={cameraProjectModalStyles.projectList.modal}>
          <View style={cameraProjectModalStyles.projectList.content}>
            <Pressable
              style={cameraProjectModalStyles.projectList.close}
            ...
            {loading ? (
              ...
              <FlatList
                ...
                data={projects}
                renderItem={({ item }) => (
                  <ProjectList project={item} setModalVisible={setModalVisible} />
                )}
