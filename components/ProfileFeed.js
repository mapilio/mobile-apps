    ...
    <TouchableOpacity style={userFeedStyles.wrapper} onPress={pressHandle}>
      <View style={userFeedStyles.imageWrapper}>
        ...
        <Image
          ...
          source={{
            uri: `${process.env.EXPO_PUBLIC_IMAGE_API}/${uploaded_hash}/${cover_photo}/480`,
          }}
      ...
      <View style={userFeedStyles.imageCount}>
        <Text style={userFeedStyles.imageCount.text}>
          {total} <Photos color="white" />
        </Text>
      </View>
      <View style={userFeedStyles.info}>
        ...
        <View style={userFeedStyles.subInfo}>
          <Text style={userFeedStyles.date}>
      ...
      <View style={userFeedStyles.status}>
        <View
          style={{
            ...userFeedStyles.status.flag,
            ...userFeedStyles.status[last_status || 'fail'],
          }}></View>
        <CustomText style={userFeedStyles.status.text}>{t(last_status || 'fail')}</CustomText>
      </View>
    </TouchableOpacity>
  );
};
