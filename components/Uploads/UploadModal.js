    ...
    <Modal animationType="slide" transparent={false} visible={visible}>
      ...
      <View style={userUploadModalStyles.container}>
        <View style={userUploadModalStyles.header}>
          <CustomTextBold style={userUploadModalStyles.title}>{t('title')}</CustomTextBold>
          <CustomText style={userUploadModalStyles.subtitle}>{t('subtitle')}</CustomText>
        </View>
        <View style={userUploadModalStyles.sequenceInfo}>
          ...
          <View style={userUploadModalStyles.sequenceInfoSide}>
            ...
            <View style={{ alignItems: 'center' }}>
              ...
              <CustomText style={userUploadModalStyles.sequenceInfoText}>{t('images')}</CustomText>
            </View>
          </View>
        </View>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: RFValue(35) }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft: RFValue(10) }}>
            <CustomTextBold style={{ fontSize: RFValue(16), color: '#191919' }}>
              {totalImageCount} {t('images')}
            </CustomTextBold>
            <CustomText style={{ fontSize: RFValue(16), color: '#191919' }}>
              {' '}
              / {totalSize > 0 ? `${totalSize}MB` : t('calculating')}
            </CustomText>
          </View>
        </View>
      </View>
      <View style={userUploadModalStyles.bottomBar}>
        <Pressable
          ...
          <CustomText
            style={{ color: '#FFF', fontSize: RFValue(12), fontFamily: 'Poppins-Medium' }}>
