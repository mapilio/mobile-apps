...
const ListItem = ({ baseStyle, isAuthUser, index, displayName, displayNameStyle, item }) => {
      ...
      {expanded && (
        <View style={styles.bottomView}>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            <View style={{ width: 5 }} />
            <Text style={styles.infoTitle}>{t('photos')}</Text>
            <CustomTextBold style={styles.infoSubTitle} adjustFontSize={false}>
              {' '}
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            <View style={{ width: 5 }} />
            <CustomText style={styles.infoTitle}>{t('roads')}</CustomText>
            <CustomTextBold style={styles.infoSubTitle} adjustFontSize={false}>
              {' '}
