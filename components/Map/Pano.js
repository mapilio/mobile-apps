      ...
      <View>
          <View style={panoStyle.topBar}>
              ...
              <View style={panoStyle.frameWrapper}>
                  ...
                  <Text style={panoStyle.frameText}>(frame 120/ <Text style={{fontFamily: 'Poppins-SemiBold'}}>45</Text>)</Text>
              </View>

              <TouchableOpacity style={panoStyle.minimize} onPress={props.minimizePano}>
                  <MinimizePano />
              </TouchableOpacity>
          </View>
          ...
          <View style={panoStyle.bottomTab}>
              ...
              <View style={panoStyle.capturerWrapper}>
                  ...
                  <Text style={panoStyle.captureDate}>April - 12.07.2020</Text>
              </View>
          </View>
      </View>
  );
