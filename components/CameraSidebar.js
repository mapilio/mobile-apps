...
import {GoBackIcon, InformationIcon, MapIcon, SettingsIcon,} from "../assets/svg/illustrations";
...
const CameraSidebar = ({navigation, setTake}) => {
    ...
    useEffect(() => {
        navigation.addListener("blur", () => {
            dispatch({type: UPDATE_SELECTED_PROJECT, payload: {type: "individual", key: 0, projectName: "lorem"}})
        });
    }, [navigation]);
