    ...
    return (
        <View style={marketplaceStyles.container}>
            ...
            <View style={marketplaceStyles.listHeader}>
                ...
                <View>
                    <TouchableOpacity style={{marginRight:RFValue(20)}} ref={touchable} onPress={() => setShowPopover(true)}>
                        <Info/>
                    </TouchableOpacity>
                    <Popover
                        placement={"bottom"}
                    ...
                    >
                        <CustomText style={marketplaceStyles.popoverText}>
                            Find or offer help on image collection and data verification projects to create fresh map
                            data in locations where it’s needed.
                        </CustomText>
                    </Popover>
                </View>
            </View>
