...
const Icon = ({ width = 32, height = 32 }) => {
  return (
    <Svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 32 32">
      <G id="other_warning_icon" transform="translate(18725 -8267)">
        <G id="Group_85335" data-name="Group 85335" transform="translate(-18725 8267)" opacity="0.2">
          <Circle id="Ellipse_2057" data-name="Ellipse 2057" cx="16" cy="16" r="16" fill="#4a90e2"/>
        </G>
        <G id="Group_85336" data-name="Group 85336" transform="translate(-18719.535 8272.465)">
          <Circle id="Ellipse_2058" data-name="Ellipse 2058" cx="10.46" cy="10.46" r="10.46" transform="translate(0 0)" fill="#4a90e2"/>
